...
<div class="admin-container">
    ...
    <div class="action-card">
        ...
        <div class="action-block">
            ...
            <a href="<?php echo e(route('groupes.csv.download')); ?>" class="admin-btn btn-blue">
                Télécharger CSV
            </a>
        </div>
        ...
        <div class="action-block">
            ...
            <form method="POST" action="<?php echo e(route('groupes.csv.upload')); ?>" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
<?php /**PATH C:\Users\pc\eduapp\resources\views/admin/groupes_csv.blade.php ENDPATH**/ ?>